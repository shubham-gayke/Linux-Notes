  ...
  return (
    <Dialog open={searchOpen} onOpenChange={setSearchOpen}>
      <DialogContent className="
        ...
        bg-background/80 dark:bg-[#0f0f12]/90
        backdrop-blur-2xl border-border/30 dark:border-white/[0.06]
      ...
      ">
        ...
        <div className="flex items-center gap-3 px-5 py-4 border-b border-border/30">
          ...
          <input
            ...
            autoFocus
          />
          <kbd className="hidden sm:inline-flex h-6 items-center gap-1 rounded-lg border border-border/50 bg-muted/50 px-2 font-mono text-[10px] font-medium text-muted-foreground/60">
            ESC
          </kbd>
        </div>
          ...
          <AnimatePresence mode="wait">
            ...
            {!query && (
              ...
              >
                ...
                <p className="text-sm text-muted-foreground font-medium">Search the Linux documentation</p>
                <p className="text-xs text-muted-foreground/50 mt-1">Type to search headings and content</p>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
        ...
        {/* Footer */}
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border/30 text-[11px] text-muted-foreground/40">
          <div className="flex items-center gap-3">
            <span className="flex items-center gap-1">
              <kbd className="w-4 h-4 rounded border border-border/50 bg-muted/50 flex items-center justify-center text-[9px]">↑</kbd>
              <kbd className="w-4 h-4 rounded border border-border/50 bg-muted/50 flex items-center justify-center text-[9px]">↓</kbd>
              navigate
            </span>
            <span className="flex items-center gap-1">
              <kbd className="h-4 rounded border border-border/50 bg-muted/50 flex items-center justify-center text-[9px] px-1">↵</kbd>
              select
            </span>
          </div>
